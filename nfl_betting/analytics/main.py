...
def main() -> None:
    ...
    print("[1/4] Computing agg_team_defense_game")
    print(f"  total rows: {load_agg_team_defense_game(con)}")

    print("[2/4] Computing agg_team_defense_season")
    print(f"  total rows: {load_agg_team_defense_season(con)}")

    print("[3/4] Computing agg_player_season_to_date")
    print(f"  total rows: {load_agg_player_season_to_date(con)}")

    print("[4/4] Creating views (view_red_zone_target_share, view_red_zone_rush_share)")
